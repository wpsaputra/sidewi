...
public class DataStrategisActivity extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener {
    ...
    private void displayFromUri() {
        ...
        try {
            pdfView.fromAsset("data_strategis_wakatobi.pdf")
                    .defaultPage(0)
                    .onPageChange(this)
