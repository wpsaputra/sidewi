...
public class KonsepDefinisiActivity extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener {
    ...
    private void displayFromUri() {
        ...
        try {
            pdfView.fromAsset("konsep_definisi.pdf")
                    .defaultPage(0)
                    .onPageChange(this)
